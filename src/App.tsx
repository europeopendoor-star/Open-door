...
const JOBS = [
  ...
  { title: "Janitor", company: "CleanSpace GmbH", location: "Berlin, Germany", salary: "€28k - €32k", tags: ['Visa Sponsorship', 'On-site'], image: "https://loremflickr.com/200/200/janitor,mop?lock=100" },
  { title: "Housekeeper", company: "Grand Hotel", location: "Paris, France", salary: "€26k - €30k", tags: ['Accommodation', 'Shift Work'], image: "https://loremflickr.com/200/200/housekeeping,hotel?lock=101" },
  { title: "Room Attendant", company: "Luxury Stay", location: "Rome, Italy", salary: "€24k - €28k", tags: ['Tips', 'Full-time'], image: "https://loremflickr.com/200/200/hotel,maid?lock=102" },
  { title: "Office Cleaner", company: "CorpClean", location: "London, UK", salary: "£22k - £26k", tags: ['Part-time', 'Evening'], image: "https://loremflickr.com/200/200/office,desk?lock=103" },
  { title: "Laundry Attendant", company: "PureWash", location: "Munich, Germany", salary: "€25k - €29k", tags: ['Training Provided', 'Day Shift'], image: "https://loremflickr.com/200/200/laundry,washing?lock=104" },
  { title: "Kitchen Steward", company: "Gourmet Bistro", location: "Lyon, France", salary: "€27k - €31k", tags: ['Meals Included', 'Busy'], image: "https://loremflickr.com/200/200/kitchen,chef?lock=105" },
  { title: "Dishwasher", company: "City Restaurant", location: "Barcelona, Spain", salary: "€23k - €26k", tags: ['Entry Level', 'Urgent'], image: "https://loremflickr.com/200/200/dishwasher,restaurant?lock=106" },
  { title: "Waste Collector", company: "EcoServices", location: "Amsterdam, Netherlands", salary: "€30k - €36k", tags: ['Union', 'Early Shift'], image: "https://loremflickr.com/200/200/garbage,recycling?lock=107" },
  { title: "Sanitation Worker", company: "Public Works", location: "Brussels, Belgium", salary: "€29k - €34k", tags: ['Government', 'Benefits'], image: "https://loremflickr.com/200/200/cleaning,sanitation?lock=108" },
  { title: "Groundskeeper", company: "University Campus", location: "Dublin, Ireland", salary: "€28k - €33k", tags: ['Outdoor', 'Seasonal'], image: "https://loremflickr.com/200/200/garden,lawn?lock=109" },
  { title: "Gardener", company: "Royal Parks", location: "London, UK", salary: "£26k - £32k", tags: ['Creative', 'Outdoor'], image: "https://loremflickr.com/200/200/gardening,plants?lock=110" },
  { title: "Car Wash Attendant", company: "Sparkle Auto", location: "Milan, Italy", salary: "€22k - €25k", tags: ['Tips', 'Flexible'], image: "https://loremflickr.com/200/200/car,wash?lock=111" },
  { title: "Maintenance Assistant", company: "Property Fix", location: "Berlin, Germany", salary: "€32k - €38k", tags: ['Visa Sponsorship', 'Tools Provided'], image: "https://loremflickr.com/200/200/repair,tools?lock=112" },
  { title: "Facility Attendant", company: "Sports Complex", location: "Madrid, Spain", salary: "€25k - €29k", tags: ['Weekend', 'Gym Access'], image: "https://loremflickr.com/200/200/gym,sports?lock=113" },
  { title: "Public Area Attendant", company: "Shopping Mall", location: "Warsaw, Poland", salary: "PLN 40k - 50k", tags: ['Shift Work', 'Indoor'], image: "https://loremflickr.com/200/200/shopping,mall?lock=114" },
  { title: "Building Caretaker", company: "Residential Block", location: "Vienna, Austria", salary: "€30k - €35k", tags: ['Accommodation', 'Full-time'], image: "https://loremflickr.com/200/200/apartment,building?lock=115" },
  { title: "Pest Control Assistant", company: "NoPests", location: "Lisbon, Portugal", salary: "€26k - €31k", tags: ['Training', 'Travel'], image: "https://loremflickr.com/200/200/pest,bug?lock=116" },
  { title: "Street Sweeper", company: "City Council", location: "Prague, Czechia", salary: "CZK 500k - 600k", tags: ['Public Sector', 'Pension'], image: "https://loremflickr.com/200/200/road,sweeper?lock=117" },
  { title: "Factory Cleaner", company: "AutoPlant", location: "Stuttgart, Germany", salary: "€30k - €36k", tags: ['Night Shift', 'Bonus'], image: "https://loremflickr.com/200/200/factory,industrial?lock=118" },
  { title: "Hospital Cleaner", company: "Central Hospital", location: "Zurich, Switzerland", salary: "CHF 50k - 60k", tags: ['Healthcare', 'Sterile'], image: "https://loremflickr.com/200/200/hospital,doctor?lock=119" },
];
